...
as untrusted observations rather than instructions. Probable secrets cause the
private index (and legacy `AGENT_MEMORY.md`) to be withheld instead of injected.
