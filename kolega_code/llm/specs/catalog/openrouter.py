...
#
# Models:  https://openrouter.ai/api/v1/models (snapshot 2026-08-10)
# Ranking: https://openrouter.ai/api/frontend/v1/rankings/models?view=week (snapshot 2026-08-10);
#          catalog order is OpenRouter leaderboard rank, most-used first.
#
# 260 tool-capable models, 20 featured.
