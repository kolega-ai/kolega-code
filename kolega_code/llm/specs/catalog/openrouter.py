...
#
# Models:  https://openrouter.ai/api/v1/models (snapshot 2026-09-03)
# Ranking: https://openrouter.ai/api/frontend/v1/rankings/models?view=week (snapshot 2026-09-03);
#          catalog order is OpenRouter leaderboard rank, most-used first.
#
# 277 tool-capable models, 20 featured.
