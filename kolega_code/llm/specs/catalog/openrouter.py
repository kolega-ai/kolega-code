...
#
# Models:  https://openrouter.ai/api/v1/models (snapshot 2026-08-20)
# Ranking: https://openrouter.ai/api/frontend/v1/rankings/models?view=week (snapshot 2026-08-20);
#          catalog order is OpenRouter leaderboard rank, most-used first.
#
# 273 tool-capable models, 20 featured.
