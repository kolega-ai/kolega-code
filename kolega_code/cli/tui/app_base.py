...
class KolegaAppBase(App):
    ...
    if TYPE_CHECKING:
        ...
        #: /handoff generation guard flag and the cancel event Esc sets mid-request.
        _handoff_in_progress: bool
        _handoff_cancel_event: asyncio.Event | None
